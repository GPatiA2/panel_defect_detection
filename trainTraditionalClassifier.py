...
trainer = pl.Trainer(devices = 1, max_epochs=opt.epochs, callbacks=callback_list, logger = tensorboard_log ,accelerator='cpu', log_every_n_steps=3, enable_checkpointing = False)
